...
DEFAULT_PROFILE = {
    ...
    "cefr_level": None,          # set after first assessment
    "target_level": "B2",
...
def load() -> dict:
    """Load student profile from disk. Returns default if not found."""
...
def update_after_session(duration_minutes: int) -> None:
    """Update profile stats after a session."""
    profile = load()
...
def set_level(cefr_level: str) -> None:
    """Set CEFR level after assessment."""
    profile = load()
